...
Route.group(()=>{
    ...
    Route.post('/iniciarPartida/:request','MongosController.guardarMongo')
    Route.put('/modificarMonitor/:request','MongosController.modificarMonitor')
    Route.put('/modificarPos/:request','MongosController.modificarPos')
    Route.put('/agregarJugador/:request', 'MongosController.agregarJugador')
    Route.get('/getPartida/:id', 'MongosController.getPartida')
    Route.get('/getComentarios/:id','MongosController.verComent')
    Route.get('/verPartidas','MongosController.verPartidas')
    Route.delete('/deletePartido/:id','MongosController.delete')
    Route.get('/getFederacion','FederacionsController.show')
    Route.post('/agregarFederacion/:request','FederacionsController.store')
    Route.delete('/deleteFederacion/:id','FederacionsController.delete')
    Route.get('/getEquipomod/:id','EquiposController.DatosEquipoMod')
}).middleware('auth:api')
